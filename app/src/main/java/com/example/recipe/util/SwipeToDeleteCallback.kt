...
abstract class SwipeToDeleteCallback internal constructor(var mContext: RecipeListFragment) :
    ...
    init {
        ...
        deleteDrawable = mContext.context?.let { ContextCompat.getDrawable(it, R.drawable.ic_delete_white) }
